// src/auth-shared.jsx
// Gedeelde auth logica voor zowel web als android
...
export const G = "#639922", GL = "#EAF3DE", GM = "#3B6D11";
...
export function Btn({ children, onClick, disabled, full, ghost, google }) {
  if (google) return (
...
export function HouseholdScreen({ user, onReady }) {
...
// ─── Loading screen ───────────────────────────────────────────────────────────
export function LoadingScreen({ message = "Laden..." }) {
  return (
    <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: "#f5f5f3", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
      ...
      <div style={{ fontSize: 13, color: "#aaa" }}>{message}</div>
    </div>
  );
}
